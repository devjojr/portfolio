      ...
      <div className="w-full">
        <div className="relative w-screen h-[50vh]">
          ...
          <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2">
            <h2 className="py-2">MERN NOTES</h2>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-5 gap-8 py-8 max-w-[1240px] mx-auto p-2">
          <div className="col-span-4">
            ...
            <p>
              A full-stack CRUD application that provides Create, Read, Update,
              and Delete functionalities for notes. The frontend is built with
              React, and the backend is powered by Node.js and Express. MongoDB
              serves as the database, and the application includes user
              authentication and route protection.
            </p>
            <a
              href="https://github.com/devjojr/mern-notes"
              target="_blank"
              rel="noreferrer"
            >

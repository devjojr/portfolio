      ...
      <div className="w-full">
        ...
        <div className="grid md:grid-cols-5 gap-8 py-8 max-w-[1240px] mx-auto p-2">
          <div className="col-span-4">
            ...
            <p>
              A web application that allow users to retrieve weather information
              for a specific city. The app uses OpenWeatherMap API to fetch
              real-time weather data.
            </p>
            <a
              href="https://github.com/devjojr/weather_app"
              target="_blank"
              rel="noreferrer"
            >
